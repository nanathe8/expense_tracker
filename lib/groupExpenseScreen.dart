...
class _GroupExpenseScreenState extends State<GroupExpenseScreen> {
  ...
  Future<void> fetchGroupData() async {
    ...
    final expenseResponse = await http.get(Uri.parse('${CONFIG.SERVER}/getGroupExpenses.php'));
    final budgetResponse = await http.get(Uri.parse('${CONFIG.SERVER}/getGroupBudget.php'));
